...
console.log(`- Losango de diagonal maior 32cm e diagonal menor 18com: ${Ex.getLosangoArea(32, 18)}cm²`);
console.log(`- Losango de diagonal maior 200cm e diagonal menor 50com: ${Ex.getLosangoArea(200, 50)}cm²`);
console.log(`- Losango de diagonal maior 75cm e diagonal menor 25com: ${Ex.getLosangoArea(75, 25)}cm²`);
